# ESA Standard Licence — terms snapshot

Verbatim capture of the terms page that "ESA Standard Licence" labels on esa.int
image pages link to. Kept here so the licence this repository's ESA-sourced
photos were accepted under stays auditable even if ESA revises the page.

- Source: <https://www.esa.int/ESA_Multimedia/Terms_and_conditions_of_use_of_images_and_videos_available_on_the_esa_website>
